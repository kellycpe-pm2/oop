...
public class TestUser {
    ...
    public static void accessmenu(User user) {
        if (user.getAccessPassword().equals("12345")) {
            organizer = new Organizer(user.getAccessUsername(), user.getAccessPassword(), user.getAccessEmail(),
                    user.getAccessContactNo());
            organizerMenu();
        } else {
            attendee = new Attendee(user.getAccessUsername(), user.getAccessPassword(), user.getAccessEmail(),
                    user.getAccessContactNo());
