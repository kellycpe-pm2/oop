public class signUp {
    ...
    public boolean validationEmpty() {
        if (this.signUpName.strip().isEmpty() || this.signUpEmail.strip().isEmpty()
                || this.signUpPassword.strip().isEmpty() || this.signUpPassword2.strip().isEmpty()) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean getResult() {
        if (validationExist() && validationName() && validationEmail() && validationPassword() && validationPassword2()
                && validationEmpty()) {
            return true;
        } else {
            return false;
